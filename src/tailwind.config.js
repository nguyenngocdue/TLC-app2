...
module.exports = {
    ...
    safelist: [
        ...
        {
            pattern: /rounded-(4|5|6)xl/, // Matches rounded-4xl, rounded-5xl, rounded-6xl
            variants: ['hover', 'sm', 'lg'], // Optional: adds hover, sm:, lg: variants
        },
        {
            pattern:
    ...
    theme: {
        extend: {
            ...
            borderRadius: {
                '4xl': '2rem', // Customize this value
                '5xl': '2.5rem', // Customize this value
                '6xl': '3rem', // Optional
            },
