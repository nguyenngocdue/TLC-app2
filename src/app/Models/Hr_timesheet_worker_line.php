...
class Hr_timesheet_worker_line extends ModelExtended
{
    protected $fillable = [
        // 'timesheetable_type', 'timesheetable_id', 
        'hr_timesheet_worker_id',
        // 'start_time',
        // 'duration_in_min',
        'duration_in_hour',
        'ot_in_hour',
    ...
    public static $eloquentParams = [
        ...
        "getParent" => ['belongsTo', Hr_timesheet_worker::class, 'hr_timesheet_worker_id'],
    ];
    ...
    public function getManyLineParams_Workers()
    {
        return [
            ...
            // ['dataIndex' => 'timesheetable_type', 'title' => 'Parent Type', 'invisible' => true, 'value_as_parent_type' => true],
            // ['dataIndex' => 'timesheetable_id', 'title' => 'Parent ID', 'invisible' => true, 'value_as_parent_id' => true],
            ['dataIndex' => 'hr_timesheet_worker_id', 'title' => 'Parent ID', 'invisible' => true, 'value_as_parent_id' => true],
            ...
            ['dataIndex' => 'ot_in_hour', 'cloneable' => true, 'footer' => 'agg_sum'],
