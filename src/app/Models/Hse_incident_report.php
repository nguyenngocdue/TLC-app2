...
class Hse_incident_report extends ModelExtended
{
    protected $fillable = [
        ...
        'first_date', 'employed_duration_in_year', 'injured_staff_department', 'loss_value', 'need_to_transfer_position'
    ];
    ...
    public $eloquentParams = [
        ...
        "getInjuredStaffDepartment" => ['belongsTo', Department::class, 'injured_staff_department'],
    ...
    public function getInjuredStaffDepartment()
    {
        $p = $this->eloquentParams[__FUNCTION__];
        return $this->{$p[0]}($p[1], $p[2]);
    }
