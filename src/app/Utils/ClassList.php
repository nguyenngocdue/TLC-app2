...
class ClassList
{
    const TEXT     = "(CLASSLIST-TEXT)     block w-full rounded-md border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 sm:text-sm focus:border-1 focus:border-blue-600 dark:focus:border-blue-600 focus:outline-none px-1 py-2 h-[42px] (END-OF-CLASSLIST)";
    const TEXTAREA = "(CLASSLIST-TEXTAREA) block w-full rounded-md border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 sm:text-sm focus:border-1 focus:border-blue-600 dark:focus:border-blue-600 focus:outline-none px-1 py-2 (END-OF-CLASSLIST)";
    const DROPDOWN = "(CLASSLIST-DROPDOWN) block w-full rounded-md border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 sm:text-sm focus:border-1 focus:border-blue-600 dark:focus:border-blue-600 focus:outline-none px-1 py-2 (END-OF-CLASSLIST)";
    ...
    const BUTTON = "(CLASSLIST-BUTTON) font-medium leading-tight uppercase rounded transition duration-150 ease-in-out focus:ring-0 focus:outline-n1one (END-OF-CLASSLIST)";
