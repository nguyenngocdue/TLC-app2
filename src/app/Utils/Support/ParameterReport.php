...
class ParameterReport
{
    ...
    public static function getDataForParameterReport($nameConfig)
    { // example: prod_discipline_id
    ...
    public static function formatValueParams($params)
    {
        foreach ($params as &$value) {
            if (is_array($value)) $value = str_replace(['[', ']'], ['', ''], json_encode($value));
        }
        return $params;
    }
}
