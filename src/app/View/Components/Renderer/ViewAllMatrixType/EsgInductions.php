...
class EsgInductions extends ViewAllTypeMatrixParent
{
    ...
    protected $dataIndexX = "the_month";
    ...
    protected function getMatrixDataSource($xAxis)
    {
        ...
        $lines = Esg_induction::query()
            ->whereYear('the_month', $selectedYear)
            ->select(["*", DB::raw(" substr(the_month,1,7) as the_month")])
            ->get();
        // dump($lines);
        return $lines;
    }
