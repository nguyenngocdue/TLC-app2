...
abstract class ManageLinePropController extends Controller
{
    protected $type = "";
    ...
    {
        $type = $this->type;
        $patch = storage_path() . "/json/$type/manageline.json";
        $patchTableName = storage_path() . "/json/table/$type/tablename.json";
    ...
    public function store(Request $request){
        ...
        try {
            Storage::disk('json')->put("{$this->type}/manageline.json",$jsonManageUser,'public');
    ...
    public function destroy($name){
        $patch = storage_path() . "/json/{$this->type}/manageline.json";
        $dataManageUser = json_decode(file_get_contents($patch), true);
        unset($dataManageUser[$name]);
        try {
            Storage::disk('json')->put("{$this->type}/manageline.json",json_encode($dataManageUser),'public');
            Toastr::success('Save file json successfully', 'Save file json');
