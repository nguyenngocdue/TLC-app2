...
class ComponentLib extends Controller
{
    public function index()
    {
        $tableColumns = [
            ...
            [
                "title" => 'Client1', "dataIndex" => "client",
        ...
        $tableDatasource = [
            [
                "id" => 1, "client" => "Maria", "amount" => 1213.45, "status" => "Approved", "color" => "green", "date" => "26/10/2022"
            ],
            [
                ...
                "id" => 2, "client" => "Hans", "amount" => 863.45, "status" => "ABC", "date" => "06/10/2022"
            ],
            [
                ...
                "id" => 3, "client" => "Jolina", "amount" => 123.45, "status" => "Pending", "color" => "orange", "date" => "07/10/2022"
            ],
            [
                ...
                "id" => 4, "client" => "Sarah", "amount" => 456.45, "status" => "Rejected", "color" => "red", "date" => "08/10/2022"
            ],
            [
                ...
                "id" => 5, "client" => "Rulia", "amount" => 789.45, "status" => "Expired", "color" => "gray", "date" => "09/10/2022"
            ],
            [
                ...
                "id" => 6, "client" => "Dave", "amount" => 1011.45, "status" => "Approved", "color" => "green", "date" => "16/10/2022"
            ],
        ];

        return view('componentLib')->with(compact('tableColumns', 'tableDatasource'));
    }
}
