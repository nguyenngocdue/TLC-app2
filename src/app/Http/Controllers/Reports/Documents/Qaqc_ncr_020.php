...
class Qaqc_ncr_020 extends Report_ParentDocument2Controller
{

    use TraitCreateChartFromGrafana;
    protected $mode = '020';
    protected $projectId = 5;
    protected $viewName = 'document-ncr-020';
    ...
    {
        $common1 = 'https://grafana.tlcmodular.com/d-solo/e6d647c2-948d-46b6-a0d6-5f444ba8125f/non-conformance-reports?orgId=1';
        // $common1 = 'http://localhost:3000/d-solo/b2728425-b3e1-4bdb-9d57-1e527cb3fd7b/test-laravel?orgId=1';
        $urlCharts = [
            [
                'panelId' => 2,
                'base_url' =>  $common1,
        ...
        return $this->createChartFromGrafana($urlCharts, $params);
    }
