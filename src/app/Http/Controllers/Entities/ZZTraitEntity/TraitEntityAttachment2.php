...
{
    private function handleUpload2($request)
    {
    ...
    private function setMediaParent2($data, $colNamesHaveAttachment)
    {
        // dd($data);
    ...
    private function deleteMediaIfNeeded2($dataInput)
    {
    ...
    private function saveAndGetIdsMedia2($request, $dataInput)
    {
        // dd($dataInput);
