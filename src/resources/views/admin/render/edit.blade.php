<div class="fixed inset-0 z-20 hidden items-center justify-center overflow-y-auto overflow-x-hidden outline-none focus:outline-none"
    id="modal-id">
    <div class="relative my-6 mx-auto w-auto max-w-3xl">
        ...
        <form action="" method="post" id="form-edit"
            ...
            <div class="flex items-start justify-between rounded-t border-b border-solid border-slate-200 p-5">
                <h3 class="p-5 text-3xl font-semibold">
                    Edit Role ID
                </h3>
                <button
...
<div class="fixed inset-0 z-30 hidden bg-black opacity-25" id="modal-id-backdrop"></div>
