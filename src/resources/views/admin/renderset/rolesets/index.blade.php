                        ...
                        <tbody class="divide-y bg-white dark:divide-gray-700 dark:bg-gray-800">
                            @foreach ($users as $user)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <div class="flex">
                                            <a href="{{ route('setrolesets.edit', $user->id) }}"
                                                class="focus:shadow-outline-purple rounded-lg border border-transparent bg-emerald-500 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 hover:bg-emerald-200 focus:outline-none active:bg-emerald-600"
                                                type="button">
                                                Role Set
                                            </a>
                                            <a href="{{ route('setrolesets.impersonate', $user->id) }}"
