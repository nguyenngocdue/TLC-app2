    ...
    <div class="container mx-auto grid px-6">
        <div class="mt-2 grid grid-cols-2 gap-5">
            <form action="{{ route('setrolesets.index') }}" method="GET">
                <div class="mt-2 grid grid-cols-2 gap-5">
                    <div>
                        <input type="text" name="search" class="block w-full rounded-md border border-slate-300 bg-white px-3 py-2 placeholder-slate-400 shadow-sm focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" value="{{ $search }}">
                    </div>
                    <div>
            ...
            <form action="{{ route('setrolesets.index') }}" method="GET">
                <div class="mt-2 flex">
                    <div class="mr-1 w-12">
                        <input type="text" name="page_limit" class="block w-12 rounded-md border border-slate-300 bg-white px-3 py-2 placeholder-slate-400 shadow-sm focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" value="{{ $pageLimit }}">
                    </div>
                    <div>
