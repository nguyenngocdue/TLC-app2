@extends('layouts.app')
@section('title', 'Set Roles (to RoleSet)')
@section('content')
        ...
        <div class="mb-8 rounded-lg bg-white px-6 py-4 shadow-md dark:bg-gray-800">
            <div class="w-full overflow-x-auto">
                <form action="{{ route('setroles.store2') }}" method="POST">
                    ...
                    <span class="my-4 rounded-full bg-green-100 px-2 py-1 text-base font-medium leading-tight text-green-700 dark:bg-green-700 dark:text-green-100">{{ $value }}</span>
