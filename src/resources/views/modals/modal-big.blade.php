<template x-if="isModalOpening['{{$modalId}}']">
    <div tabindex="-1" class="fixed sm:p-0 p-0 lg:p-4 top-0 left-0 right-0 bottom1-0 z-50 h-full bg-gray-100 dark:bg-slate-400 dark:bg-opacity-70 bg-opacity-70 justify-center items-center flex" aria-hidden="true" @keydown.escape="closeModal('{{$modalId}}')">
