                    ...
                    <tbody class="divide-y bg-white dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3 text-center text-sm">
                                <button class="focus:shadow-outline-gray btn-delete-user rounded-lg px-2 py-2 text-sm font-medium leading-5 text-red-600 focus:outline-none dark:text-red-400" data-url="{{ route($type . '_renderprop.destroy', $user->id) }}" ​ type="button"><i class="fas fa-trash"></i></button>
                            </td>
                            ...
                            @case('count')
                            <td class="text-center">
                                <x-render.count count="{{ $user->{$item['column_name']} ? $user->{$item['column_name']}->count() : '0' }}" />
                            </td>
                            @break
                            ...
                            <td class="px-4 py-3">
                                ...
                                <x-render.user src="https://wp.tlcmodular.com/wp-content/uploads/2022/07/bfdc18a057769428cd67-150x150.jpg" name_rendered="{{ $user->{$item['column_name']}->name_rendered }}" email="{{ $user->{$item['column_name']}->email }}" />
                                @else
                                @endif
                            </td>
                            @endswitch
