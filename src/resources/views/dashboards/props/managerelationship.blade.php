                    ...
                    <table id="table_manage" class="whitespace-no-wrap w-full">
                        ...
                        <tbody class="divide-y bg-white dark:divide-gray-700 dark:bg-gray-800">
                            ...
                            <tr class="table-line-{{ $colorLines[$key] }} text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <input type="text" class="mt-1 block w-full max-w-fit rounded-md border border-slate-300 bg-white px-3 py-2 text-center placeholder-slate-400 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" name="control_param[]" value="{{ $columnControlParams[$key] }}">
                                </td>
                                <td>
                                    <input type="text" class="mt-1 block w-full max-w-fit rounded-md border border-slate-300 bg-white px-3 py-2 text-center placeholder-slate-400 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" name="column_name[]" value="{{ $columnNames[$key] }}">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <select name="hidden[]" class="mt-1 block w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-left placeholder-slate-400 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm">
                                        <option value="" @if ($columnHidden[$key]=='' ) selected @endif></option>
                                        <option value="true" @if ($columnHidden[$key]==='true' ) selected @endif>True</option>
                                    </select>
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    <select name="new_line[]" class="mt-1 block w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-left placeholder-slate-400 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm">
                                        <option value="" @if ($columnNewLines[$key]=='' ) selected @endif></option>
                                        <option value="true" @if ($columnNewLines[$key]==='true' ) selected @endif>True</option>
                                    </select>
                                </td>
                            ...
                            <tr class="table-line-new">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <input type="text" class="mt-1 block w-full max-w-fit rounded-md border border-slate-300 bg-white px-3 py-2 text-center placeholder-slate-400 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" name="control_param[]" value="">
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    <input type="text" name="column_name[]" class="mt-1 block w-full max-w-fit rounded-md border border-slate-300 bg-white px-3 py-2 text-center placeholder-slate-400 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" value="{{ isset($columnEloquentParams[$columnRelationship][2]) ? $columnEloquentParams[$columnRelationship][2] : '' }}">
                                </td>
                                <td class="px-4 py-3 text-sm">
