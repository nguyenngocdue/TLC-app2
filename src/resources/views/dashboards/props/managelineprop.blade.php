                ...
                <div class="w-full overflow-x-auto">
                    <table class="whitespace-no-wrap w-full">
                        ...
                        <tbody class="divide-y bg-white dark:divide-gray-700 dark:bg-gray-800">
                            ...
                            $errorsLineProp = "Setting Prop Control json fail! Please fix
                            file controls.json before Run.";
                            }
                            @endphp
                            ...
                            <tr class="table-line-{{ $colorLines[$key] }} text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 text-center text-sm">
                                    ...
                                    <input type="text" name="table_name[]" value="{{ $columnTableNames[$key] ?? '' }}" readonly hidden>
                                </td>
                                <td class="px-4 py-3 text-center text-sm">
                                    {{ $columnNames[$key] }}
                                ...
                                <td class="px-4 py-3 text-center text-sm">
                                    ...
                                    <button class="btn btn-danger btn-delete" data-url="{{ route($type . '_mnglnprop.destroy', $name) }}" ​ type="button"><i class="fas fa-trash"></i></button>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
                            ...
                            <tr class="table-line-new text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 text-center text-sm">
                                    ...
                                    <input type="text" name="name[]" value="{{ $columnTableNames[$key] ?? '' }}|{{ $columnName }}" readonly hidden>
                                </td>
                                <td class="px-4 py-3 text-center text-sm">
                                    {{ $columnTableNames[$key] ?? '' }}
                                    <input type="text" name="table_name[]" value="{{ $columnTableNames[$key] ?? '' }}" readonly hidden>
                                ...
                                <td class="px-4 py-3 text-center text-sm">
                                    {{ $columnName }}
                                    <input type="text" name="column_name[]" value="{{ $columnName }}" readonly hidden>
                                </td>
                                <td class="px-4 py-3 text-center text-sm">
                                    {{ $columnTypes[$key] ?? '' }}
                                    <input type="text" name="column_type[]" value="{{ $columnTypes[$key] ?? '' }}" readonly hidden>
