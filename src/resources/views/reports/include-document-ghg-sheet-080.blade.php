...
@php
	...
	$colOffser = $timeCategory === 'filter_by_year' ? 2 : 5;
@endphp
...
<div class="p-2 border">
	...
	<div class="p-6 ">
		<table class="tg" style="undefined;table-layout: fixed; width: 1965px">
				...
				<tr>
					<td class="tg-73oq" colspan="{{ $colOffser + count($titleOfTime) + 3}}">Please fill in the BLUE...</td>
				</tr>
				<tr>
					<td class="tg-73oq" colspan="{{ $colOffser + count($titleOfTime) + 3}}">Please also fill in the blank BLUE CELLS</td>
				</tr>
				<tr>
					<td class="tg-73oq" colspan="{{ $colOffser + count($titleOfTime) + 3}}">Please confirm/revise</td>
				</tr>
				...
				<tr>
					...
					@else
						...
						@endforeach
					@endif
					<td class="tg-qjmw" colspan="2"></td>
				</tr>
				<tr>
					<td class="tg-jpxn" colspan="6">ENVIROMENT</td>
					<td class="tg-f7v4" colspan="{{ $timeCategory === 'filter_by_year' ? 3:  count($titleOfTime)}}"><span style="font-weight:bold">Reporting Boundary:</span> Vietnam faciticies (TF1, TF2 and TF3)</td>
					<td class="tg-73oq" colspan="2"></td>
				</tr>
				...
				<tr>
					...
					<td class="tg-npz6" colspan="{{$timeCategory === 'filter_by_year' ? 3: count($titleOfTime)}}"><span style="font-weight:bold">Reporting Boudary: </span>Vietnam facilities (TF1, TF2 and TF3)</td>
					<td class="tg-73oq" colspan="2">ADM (20210108): Please confirm whether the social dât only covers those stated in green cell. ....</td>
				</tr>
