...
<div class="flex justify-center bg-only-print">
    <div class="md:px-4">
        <div style='page-break-after:always!important' class="w-[1000px] min-h-[1360px] items-center bg-white box-border p-8">
            ...
            <div>
                <x-renderer.heading level=3 xalign='left' class='text-blue-600 font-semibold'>Company's carbon footprint in the year {{$year}}</x-renderer.heading>
                <div class="grid grid-rows-1 pt-2">
                    <div class="grid grid-cols-12 text-center">
                        <div class="col-span-6 m-auto">
                            <div class='w-60 h-60 bg-green-400 p-3 flex justify-between flex-col '>
