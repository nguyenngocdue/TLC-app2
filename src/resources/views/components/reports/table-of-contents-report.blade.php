...
<div class="fixed left-0 z-20 no-print ">
...
<div id="drawer-left" class=" no-print hidden fixed min-w-[200px] left-100 z-20 shadow-xl h-screen px-2 py-4 overflow-y-auto  bg-white w-auto dark:bg-gray-800 top-[340px] transition-transform duration-[3000ms] ease-in-out " tabindex="-1" aria-labelledby="drawer-left-label" aria-modal="false" role="dialog" >
