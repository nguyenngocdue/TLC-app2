<button class="relative align-middle rounded-md focus:outline-none focus:shadow-outline-purple" @click="toggleSearchMenu" @keydown.escape="closeSearchMenu" accesskey="q" aria-label="Search" aria-haspopup="true">
  ...
  <template x-if="isSearchMenuOpen">
    <div tabindex="-1" class="fixed sm:p-0 md:p-0 top-0 left-0 right-0 z-50 lg:p-4 h-full bg-gray-100 dark:bg-slate-400 dark:bg-opacity-70 bg-opacity-70 justify-center items-center flex" aria-hidden="true"  @keydown.escape="closeSearchMenu">
        <div class="relative my-20 sm:mx-0 sm:my-12 md:mx-16 md:my-48 w-full lg:mx-20 xl:mx-56 2xl:mx-96 h-auto md:h-auto sm:h-auto" @click.away="closeSearchMenu">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <div class="px-6 overflow-y-auto h-[300px] md:h-[500px]" data-container>
