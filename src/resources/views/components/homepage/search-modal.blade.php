<button class="relative align-middle rounded-md focus:outline-none focus:shadow-outline-purple" @click="toggleSearchMenu" @keydown.escape="closeSearchMenu" accesskey="q" aria-label="Search" aria-haspopup="true">
    <i class="fa-solid fa-magnifying-glass"></i>
</button>
  <template x-if="isSearchMenuOpen">
    <div tabindex="-1" class="fixed sm:p-0 md:p-0 top-0 left-0 right-0 z-50 lg:p-4 h-full bg-gray-200 dark:bg-slate-400 dark:bg-opacity-70 bg-opacity-70 justify-center items-center flex" aria-hidden="true"  @keydown.escape="closeSearchMenu">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="items-center justify-between p-4 border-b rounded-t dark:border-gray-600">
                    <div class="flex">
                        ...
                        <button type="button" @click="closeSearchMenu" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="large-modal">
