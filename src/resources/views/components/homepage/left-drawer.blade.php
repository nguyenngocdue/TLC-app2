 @props(['title' => ""])
 <!-- drawer component -->
 <div id="drawer-left" class="fixed top-16 left-0 z-10 shadow-xl h-screen px-2 py-4 overflow-y-auto transition-transform -translate-x-full bg-white w-auto dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-left-label">
