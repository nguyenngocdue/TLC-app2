<div class="text-center">
 ...
 <!-- drawer component -->
 <div id="drawer-right-example" class="fixed top-72 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform translate-x-full transform-no1ne bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-right-label">
