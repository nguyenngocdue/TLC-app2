<button class="focus:shadow-outline-purple rounded-md focus:outline-none text-xl" @click="toggleMenuApps" @keydown.escape="closeMenuApps">
    <i class="fa-solid fa-bars"></i>
</button>
<template x-if="isMenuAppsOpen">
    <ul x-transition:leave="transition ease-in duration-150" 
        x-transition:leave-start="opacity-100" 
        x-transition:leave-end="opacity-0" 
        @click.away="closeMenuApps" 
        @keydown.escape="closeMenuApps" 
