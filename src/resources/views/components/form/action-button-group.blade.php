<div class="w-full lg:w-1/3 p-2 lg:p-0 items-center">
    <div class="lg:flex lg:justify-center lg:gap-2">
        <x-renderer.button type="secondary" outline=true href="{{route($type.'_ep.exportCSV')}}" target="_blank" title="Export this list to CSV" icon="fa-duotone fa-file-csv"></x-renderer.button>
