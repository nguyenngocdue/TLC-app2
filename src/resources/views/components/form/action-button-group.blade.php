{{-- <div class="w-full lg:w-1/3 p-2 lg:p-0 items-center"> --}}
    {{-- <div class="lg:flex lg:justify-center lg:gap-2"> --}}
        ...
        @if($showQrList6Button)
            <x-renderer.button class="mr-1" type="secondary" outline=true href="{{route($type.'_qr.showQRList6')}}" title="Print this list QR Code" icon="fa-duotone fa-qrcode"></x-renderer.button>
        @endif
