<form action="{{$route}}" method="post" class="w-full lg:w-1/3 p-2 lg:p-0">
    ...
    <div class="flex items-center lg:justify-end">
        <div class="w-28">
            ...
            <select name="per_page" class="block w-full rounded-md border bg-white dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 px-1 py-2 placeholder-slate-400 shadow-sm dark:focus:border-blue-600 focus:outline-none sm:text-sm">
