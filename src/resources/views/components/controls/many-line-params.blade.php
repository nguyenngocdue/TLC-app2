...
<x-renderer.button click="toggleListingTable('456')" keydown="closeListingTable('456')" id="btnAddFromAList_{{$table01Name}}" type="success" title="Add from a list">Add From A List</x-renderer.button>
<x-modals.modal-add-from-a-list modalId='456' />
@endif
@endisset
