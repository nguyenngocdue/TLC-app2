    ...
    <div class="col-span-12 text-center">
        ...
        <div class="w-1/3">
            ...
            @if(sizeof($availableExams) > 0)
                <x-renderer.heading class="mt-10 text-center" level=4>The New questionares:</x-renderer.heading>
            ...
            @if(sizeof($myInProgressSheets) > 0)
                <x-renderer.heading class="mt-10 text-center" level=4>The In Progress questionares:</x-renderer.heading>
            ...
            @if(sizeof($mySubmittedSheets) > 0)
                <x-renderer.heading class="mt-10 text-center" level=4>The Submitted questionares:</x-renderer.heading>
            ...
            @if(sizeof($myFinishedSheets) > 0)
                <x-renderer.heading class="mt-10 text-center" level=4>The Finished questionares:</x-renderer.heading>
