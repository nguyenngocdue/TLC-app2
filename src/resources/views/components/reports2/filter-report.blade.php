    ...
    <div class="bg-white rounded w-full my-2 p-2">
        <div class="w-full my-1 grid grid-cols-12 gap-2">
            <div class="col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-3 xl:col-span-2">
                ...
                <x-renderer.view-all-matrix-filter.ProjectFilter tableName="projects" name="project_id" id="project_id"
                    typeToLoadListener="qaqc_wir" selected="{{ $viewportParams['project_id'] }}" />
            </div>
            <div class="col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-3 xl:col-span-2">
            ...
            <div class="col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-3 xl:col-span-2">
                ...
                <x-renderer.view-all-matrix-filter.ProdRoutingLinkFilter tableName="prod_routing_links"
                    name="prod_routing_link_id[]" {{-- name="getRoutingLinks()[]"  --}} {{-- Just Been here --}} id="getRoutingLinks"
                    typeToLoadListener="listener_config" allowClear="true" :selected="$viewportParams['prod_routing_link_id']" multiple="true" />
            </div>
        </div>
