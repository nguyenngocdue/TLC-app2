...
<form name="{{$formName}}" action="{{$routeRp}}" method="POST" class="m-0">
    ...
    <div class="flex items-center lg:justify-end no-print">
        <div class="w-28">
            ...
            <select name="per_page" class="block w-full text-gray-700 rounded-md border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 sm:text-sm focus:border-1 focus:border-blue-600 dark:focus:border-blue-600 focus:outline-none px-2 py-2" onchange="this.form.submit()">
