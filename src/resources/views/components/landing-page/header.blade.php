...
class="fixed z-30 flex w-full items-center bg-white dark:bg-black bg-gradient-to-r from-cyan-200 via-blue-200 to-blue-300 border-b">
          ...
          <div class="flex w-full items-center justify-between px-4">
            <div>
              ...
              <nav
                ...
                id="navbarCollapse"
                class="absolute right-4 top-full w-full max-w-[250px] rounded-lg lg:bg-transparent bg-white px-6 py-5 shadow dark:bg-dark-2 lg:static lg:block lg:w-full lg:max-w-full lg:shadow-none lg:dark:bg-transparent"
              >
