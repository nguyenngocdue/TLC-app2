    ...
    <form id="{{$type}}" action="{{route($type . '.index')}}" method="GET">
        ...
        {{$currentFilter == 'basic_filter' ? '' : 'hidden'}}">
            <div class="flex h-10">
                ...
                <div class="flex h-full">
                    ...
                    <button type="button" class="px-2 text-2xl border-l" @click="toogleAdvanceFilter()">
        ...
        <div id="modal_advance_filter" class="rounded-lg border bg-gray-100 dark:bg-gray-800 border-gray-300 dark:border-gray-600 mb-5 p-3 {{$render ? '' : 'hidden'}}">
            <div class="flex h-10">
                ...
                <div class="flex">
                    <x-advanced-filter.text3  name="basic_filter" value="" placeholder='Name basic filter...' onKeyPress="onKeyPress(event)"/>
                    <x-renderer.button type="secondary" click="saveBasicFilter()" class="mx-2"><i class="fa-solid fa-floppy-disk"></i></x-renderer.button>
                    <button type="button" class="px-2 text-2xl border-l" @click="toogleAdvanceFilter()">
