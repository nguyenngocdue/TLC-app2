<div class="grid grid-row-1">
    <div class="grid grid-cols-12 items-center pr-4">
        <div class="col-start-1 col-span-4 w-full text-right whitespace-nowrap">
            <span class="px-1 ">{{ucwords(str_replace('_', " ", $name ))}}:</span>
        </div>
        <div class="col-start-6 col-span-9 w-full">
