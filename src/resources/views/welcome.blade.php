...
<body class="antialiased">
    ...
    //     $filter = "(&(objectClass=*)(mail=fortune@tlcmodular.com))";
    //     $result = ldap_search($ldapconn, $dc_str, $filter) or exit("Unable to search");
    ...
    <div class="items-top relative flex min-h-screen justify-center bg-gray-100 py-4 dark:bg-gray-900 sm:items-center sm:pt-0">
        ...
        <div class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
            ...
            @else
            <a href="{{ route('login') }}" class="text-sm text-gray-700 underline dark:text-gray-500">{{ __('Log in 2') }}</a>

            @if (Route::has('register'))
            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline dark:text-gray-500">{{ __('Register_1') }}</a>
            @endif
