import { ControlAttributeAction, ControlAttributeActionCheckbox, ControlAttributeActionPrint, ControlAttributeAggCount, ControlAttributeAttachment, ControlAttributeAvatarUser, ControlAttributeCheckbox, ControlAttributeColumn, ControlAttributeCustomFunction, ControlAttributeDocId, ControlAttributeDropdown, ControlAttributeHyperLink, ControlAttributeIdLink, ControlAttributeIdStatus, ControlAttributeNo, ControlAttributeNumber, ControlAttributeParentLink, ControlAttributePickerDatetime, ControlAttributeQrCode, ControlAttributeSearchableDialog, ControlAttributeStatus, ControlAttributeText, ControlAttributeToggle } from './EditableTable3ControlAttributeType';
...
export type TableColumn = TableColumnNo | TableColumnAction | TableColumnActionCheckbox | TableColumnActionPrint | TableColumnText | TableColumnNumber | TableColumnDropdown | TableColumnToggle | TableColumnCheckbox | TableColumnPickerDateTime | TableColumnAttachment | TableColumnSearchableDialog | TableColumnColumn | TableColumnQrCode | TableColumnDocId | TableColumnIdStatus | TableColumnIdLink | TableColumnStatus | TableColumnAggCount | TableColumnAvatarUser | TableColumnDateTime | TableColumnHyperLink | TableColumnParentLink | TableColumnCustomFunction;
export type CbbDataSourceType = {
    [key: string]: {
        [key: string]: string | number;
    };
};
export {};
//# sourceMappingURL=EditableTable3ColumnType.d.ts.map