...
export interface TableCellType {
    value: number | string | TableValueObjectType | DataSourceItem | Array<number | string | TableValueObjectType | DataSourceItem>;
}
...
//# sourceMappingURL=EditableTable3DataLineType.d.ts.map