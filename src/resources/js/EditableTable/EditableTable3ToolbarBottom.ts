...
export const makeToolBarBottom = ({ tableConfig }: TableParams) => {
    ...
    return `<div class='w-full grid grid-cols-12 border-b border-red-50 rounded-b bg-gray-100 p-1vw px-4 py-3 text-xs-vw font-semibold1 tracking-wide text-gray-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300'>
