...
export const makeToolBarTop = ({ tableConfig }: TableParams) => {
    ...
    if (tableConfig.topLeftControl || tableConfig.topCenterControl || tableConfig.topRightControl)
        return `<div component="tableToolbarTop" class='w-full grid grid-cols-12 border-b border-red-50 rounded-t bg-gray-100 p-1vw px-4 py-3 text-xs-vw font-semibold1 tracking-wide text-gray-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300'>
