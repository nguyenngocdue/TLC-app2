...
return new class extends Migration
{
    ...
    protected function checkRelationShip()
    {
        ...
        $tableName = "qaqc_insp_onhold_details";
    ...
    public function up()
    {
        ...
        Schema::create($this->checkRelationShip()[0], function (Blueprint $table) {
            ...
            $table->foreign('qaqc_insp_chklst_line_id', "qaqc_insp_onhold_id")->references('id')->on(Str::plural('qaqc_insp_chklst_lines'))->onDelete('cascade');
            $table->foreign('qaqc_insp_value_id', "qaqc_insp_value_onhold_id")->references('id')->on(Str::plural('qaqc_insp_values'))->onDelete('cascade');
        });
    }
