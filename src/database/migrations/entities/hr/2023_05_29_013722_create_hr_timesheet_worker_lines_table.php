...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        $schema->create('hr_timesheet_worker_lines', function (BlueprintExtended $table) {
            $table->id();
            // $table->string("timesheetable_type")->nullable();
            // $table->unsignedBigInteger("timesheetable_id")->nullable();
            $table->foreignId("hr_timesheet_worker_id")->constrained()->onUpdate("cascade")->onDelete("cascade");
            ...
            $table->float("ot_in_hour")->nullable();
    ...
    {
        Schema::dropIfExists('hr_timesheet_worker_lines');
    }
};
