...
use App\Http\Controllers\Api\v1\HR\PublicHolidayControllerApi;
...
Route::group([
    ...
    Route::get('public-holiday-data', [PublicHolidayControllerApi::class,'index'])->name('public-holiday-data.index');
